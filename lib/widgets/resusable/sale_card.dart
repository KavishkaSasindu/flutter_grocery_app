...
class SaleCard extends StatelessWidget {
  ...
  const SaleCard({super.key,required this.title,required this.productSize,required this.price,required this.mainBoxColor,required this.smallBoxColor});
              ...
              Row(
                ...
                children: [
                   Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(productSize,style:const TextStyle(fontSize: 18,)),
                      const SizedBox(
                        height: 10,
                      ),
